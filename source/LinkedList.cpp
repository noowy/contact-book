...
void LinkedList::printList()
{
	...
	while (nextElem)
	{
		...
		if (currentElem != head)
		{
			cout << "Ňĺëĺôîí: " << currentElem->phonenumber << endl;
			cout << "Ŕáîíĺíň: " << currentElem->name << endl;
			cout << "Ŕäđĺń: " << currentElem->address << endl;
			cout << "Email ŕäđĺń: " << currentElem->email << endl << endl;
		}
		nextElem = currentElem->nextsub;
	}
}
